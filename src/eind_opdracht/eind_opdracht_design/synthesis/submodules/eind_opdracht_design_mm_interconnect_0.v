// eind_opdracht_design_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module eind_opdracht_design_mm_interconnect_0 (
		...
		input  wire        pio_keys_reset_reset_bridge_in_reset_reset,                          //                          pio_keys_reset_reset_bridge_in_reset.reset
	...
	wire  [114:0] pio_keys_s1_agent_rf_source_data;                         // pio_keys_s1_agent:rf_source_data -> pio_keys_s1_agent_rsp_fifo:in_data
	...
	wire  [114:0] pio_keys_s1_agent_rsp_fifo_out_data;                      // pio_keys_s1_agent_rsp_fifo:out_data -> pio_keys_s1_agent:rf_sink_data
	...
	wire   [20:0] pio_switches_s1_agent_m0_address;                         // pio_switches_s1_agent:m0_address -> pio_switches_s1_translator:uav_address
	...
	wire          pio_switches_s1_agent_rdata_fifo_src_valid;               // pio_switches_s1_agent:rdata_fifo_src_valid -> pio_switches_s1_agent_rdata_fifo:in_valid
	wire   [33:0] pio_switches_s1_agent_rdata_fifo_src_data;                // pio_switches_s1_agent:rdata_fifo_src_data -> pio_switches_s1_agent_rdata_fifo:in_data
	wire          pio_switches_s1_agent_rdata_fifo_src_ready;               // pio_switches_s1_agent_rdata_fifo:in_ready -> pio_switches_s1_agent:rdata_fifo_src_ready
	...
	wire   [20:0] pio_hex_s1_agent_m0_address;                              // pio_hex_s1_agent:m0_address -> pio_hex_s1_translator:uav_address
	...
	wire  [114:0] pio_hex_s1_agent_rf_source_data;                          // pio_hex_s1_agent:rf_source_data -> pio_hex_s1_agent_rsp_fifo:in_data
	...
	wire  [114:0] pio_hex_s1_agent_rsp_fifo_out_data;                       // pio_hex_s1_agent_rsp_fifo:out_data -> pio_hex_s1_agent:rf_sink_data
	...
	wire          pio_hex_s1_agent_rdata_fifo_src_valid;                    // pio_hex_s1_agent:rdata_fifo_src_valid -> pio_hex_s1_agent_rdata_fifo:in_valid
	wire   [33:0] pio_hex_s1_agent_rdata_fifo_src_data;                     // pio_hex_s1_agent:rdata_fifo_src_data -> pio_hex_s1_agent_rdata_fifo:in_data
	wire          pio_hex_s1_agent_rdata_fifo_src_ready;                    // pio_hex_s1_agent_rdata_fifo:in_ready -> pio_hex_s1_agent:rdata_fifo_src_ready
	...
	wire          pio_keys_s1_agent_rp_valid;                               // pio_keys_s1_agent:rp_valid -> router_002:sink_valid
	wire  [113:0] pio_keys_s1_agent_rp_data;                                // pio_keys_s1_agent:rp_data -> router_002:sink_data
	wire          pio_keys_s1_agent_rp_ready;                               // router_002:sink_ready -> pio_keys_s1_agent:rp_ready
	wire          pio_keys_s1_agent_rp_startofpacket;                       // pio_keys_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          pio_keys_s1_agent_rp_endofpacket;                         // pio_keys_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          pio_switches_s1_agent_rp_valid;                           // pio_switches_s1_agent:rp_valid -> router_003:sink_valid
	wire  [113:0] pio_switches_s1_agent_rp_data;                            // pio_switches_s1_agent:rp_data -> router_003:sink_data
	wire          pio_switches_s1_agent_rp_ready;                           // router_003:sink_ready -> pio_switches_s1_agent:rp_ready
	wire          pio_switches_s1_agent_rp_startofpacket;                   // pio_switches_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          pio_switches_s1_agent_rp_endofpacket;                     // pio_switches_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          pio_hex_s1_agent_rp_valid;                                // pio_hex_s1_agent:rp_valid -> router_004:sink_valid
	wire  [113:0] pio_hex_s1_agent_rp_data;                                 // pio_hex_s1_agent:rp_data -> router_004:sink_data
	wire          pio_hex_s1_agent_rp_ready;                                // router_004:sink_ready -> pio_hex_s1_agent:rp_ready
	wire          pio_hex_s1_agent_rp_startofpacket;                        // pio_hex_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          pio_hex_s1_agent_rp_endofpacket;                          // pio_hex_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [113:0] pio_leds_s1_agent_rp_data;                                // pio_leds_s1_agent:rp_data -> router_005:sink_data
	...
	wire          cmd_mux_src_valid;                                        // cmd_mux:src_valid -> pio_keys_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> pio_keys_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // pio_keys_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [3:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> pio_keys_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                // cmd_mux:src_startofpacket -> pio_keys_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                  // cmd_mux:src_endofpacket -> pio_keys_s1_burst_adapter:sink0_endofpacket
	wire          pio_keys_s1_burst_adapter_source0_valid;                  // pio_keys_s1_burst_adapter:source0_valid -> pio_keys_s1_agent:cp_valid
	wire  [113:0] pio_keys_s1_burst_adapter_source0_data;                   // pio_keys_s1_burst_adapter:source0_data -> pio_keys_s1_agent:cp_data
	wire          pio_keys_s1_burst_adapter_source0_ready;                  // pio_keys_s1_agent:cp_ready -> pio_keys_s1_burst_adapter:source0_ready
	wire    [3:0] pio_keys_s1_burst_adapter_source0_channel;                // pio_keys_s1_burst_adapter:source0_channel -> pio_keys_s1_agent:cp_channel
	...
	wire          cmd_mux_001_src_valid;                                    // cmd_mux_001:src_valid -> pio_switches_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> pio_switches_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // pio_switches_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [3:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> pio_switches_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                            // cmd_mux_001:src_startofpacket -> pio_switches_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                              // cmd_mux_001:src_endofpacket -> pio_switches_s1_burst_adapter:sink0_endofpacket
	wire          pio_switches_s1_burst_adapter_source0_valid;              // pio_switches_s1_burst_adapter:source0_valid -> pio_switches_s1_agent:cp_valid
	wire  [113:0] pio_switches_s1_burst_adapter_source0_data;               // pio_switches_s1_burst_adapter:source0_data -> pio_switches_s1_agent:cp_data
	wire          pio_switches_s1_burst_adapter_source0_ready;              // pio_switches_s1_agent:cp_ready -> pio_switches_s1_burst_adapter:source0_ready
	wire    [3:0] pio_switches_s1_burst_adapter_source0_channel;            // pio_switches_s1_burst_adapter:source0_channel -> pio_switches_s1_agent:cp_channel
	wire          pio_switches_s1_burst_adapter_source0_startofpacket;      // pio_switches_s1_burst_adapter:source0_startofpacket -> pio_switches_s1_agent:cp_startofpacket
	wire          pio_switches_s1_burst_adapter_source0_endofpacket;        // pio_switches_s1_burst_adapter:source0_endofpacket -> pio_switches_s1_agent:cp_endofpacket
	wire          cmd_mux_002_src_valid;                                    // cmd_mux_002:src_valid -> pio_hex_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_002_src_data;                                     // cmd_mux_002:src_data -> pio_hex_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                    // pio_hex_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [3:0] cmd_mux_002_src_channel;                                  // cmd_mux_002:src_channel -> pio_hex_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                            // cmd_mux_002:src_startofpacket -> pio_hex_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                              // cmd_mux_002:src_endofpacket -> pio_hex_s1_burst_adapter:sink0_endofpacket
	wire          pio_hex_s1_burst_adapter_source0_valid;                   // pio_hex_s1_burst_adapter:source0_valid -> pio_hex_s1_agent:cp_valid
	wire  [113:0] pio_hex_s1_burst_adapter_source0_data;                    // pio_hex_s1_burst_adapter:source0_data -> pio_hex_s1_agent:cp_data
	wire          pio_hex_s1_burst_adapter_source0_ready;                   // pio_hex_s1_agent:cp_ready -> pio_hex_s1_burst_adapter:source0_ready
	wire    [3:0] pio_hex_s1_burst_adapter_source0_channel;                 // pio_hex_s1_burst_adapter:source0_channel -> pio_hex_s1_agent:cp_channel
	wire          pio_hex_s1_burst_adapter_source0_startofpacket;           // pio_hex_s1_burst_adapter:source0_startofpacket -> pio_hex_s1_agent:cp_startofpacket
	wire          pio_hex_s1_burst_adapter_source0_endofpacket;             // pio_hex_s1_burst_adapter:source0_endofpacket -> pio_hex_s1_agent:cp_endofpacket
	wire          cmd_mux_003_src_valid;                                    // cmd_mux_003:src_valid -> pio_leds_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_003_src_data;                                     // cmd_mux_003:src_data -> pio_leds_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                    // pio_leds_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                  // cmd_mux_003:src_channel -> pio_leds_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                            // cmd_mux_003:src_startofpacket -> pio_leds_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                              // cmd_mux_003:src_endofpacket -> pio_leds_s1_burst_adapter:sink0_endofpacket
	wire          pio_leds_s1_burst_adapter_source0_valid;                  // pio_leds_s1_burst_adapter:source0_valid -> pio_leds_s1_agent:cp_valid
	wire  [113:0] pio_leds_s1_burst_adapter_source0_data;                   // pio_leds_s1_burst_adapter:source0_data -> pio_leds_s1_agent:cp_data
	wire          pio_leds_s1_burst_adapter_source0_ready;                  // pio_leds_s1_agent:cp_ready -> pio_leds_s1_burst_adapter:source0_ready
	wire    [3:0] pio_leds_s1_burst_adapter_source0_channel;                // pio_leds_s1_burst_adapter:source0_channel -> pio_leds_s1_agent:cp_channel
	...
	wire          pio_keys_s1_agent_rdata_fifo_out_valid;                   // pio_keys_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] pio_keys_s1_agent_rdata_fifo_out_data;                    // pio_keys_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          pio_keys_s1_agent_rdata_fifo_out_ready;                   // avalon_st_adapter:in_0_ready -> pio_keys_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                            // avalon_st_adapter:out_0_valid -> pio_keys_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                             // avalon_st_adapter:out_0_data -> pio_keys_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                            // pio_keys_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                            // avalon_st_adapter:out_0_error -> pio_keys_s1_agent:rdata_fifo_sink_error
	wire          pio_switches_s1_agent_rdata_fifo_out_valid;               // pio_switches_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] pio_switches_s1_agent_rdata_fifo_out_data;                // pio_switches_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          pio_switches_s1_agent_rdata_fifo_out_ready;               // avalon_st_adapter_001:in_0_ready -> pio_switches_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                        // avalon_st_adapter_001:out_0_valid -> pio_switches_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                         // avalon_st_adapter_001:out_0_data -> pio_switches_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                        // pio_switches_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                        // avalon_st_adapter_001:out_0_error -> pio_switches_s1_agent:rdata_fifo_sink_error
	wire          pio_hex_s1_agent_rdata_fifo_out_valid;                    // pio_hex_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] pio_hex_s1_agent_rdata_fifo_out_data;                     // pio_hex_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          pio_hex_s1_agent_rdata_fifo_out_ready;                    // avalon_st_adapter_002:in_0_ready -> pio_hex_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                        // avalon_st_adapter_002:out_0_valid -> pio_hex_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                         // avalon_st_adapter_002:out_0_data -> pio_hex_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                        // pio_hex_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                        // avalon_st_adapter_002:out_0_error -> pio_hex_s1_agent:rdata_fifo_sink_error
	wire          pio_leds_s1_agent_rdata_fifo_out_valid;                   // pio_leds_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] pio_leds_s1_agent_rdata_fifo_out_data;                    // pio_leds_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          pio_leds_s1_agent_rdata_fifo_out_ready;                   // avalon_st_adapter_003:in_0_ready -> pio_leds_s1_agent_rdata_fifo:out_ready
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (pio_keys_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (pio_keys_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (pio_switches_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (pio_switches_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (pio_switches_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (pio_switches_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (pio_switches_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (pio_switches_s1_burst_adapter_source0_channel),       //                .channel
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_switches_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                              //       clk.clk
		.reset             (pio_keys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pio_switches_s1_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (pio_switches_s1_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (pio_switches_s1_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (pio_switches_s1_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (pio_switches_s1_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (pio_switches_s1_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (pio_hex_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (pio_hex_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (pio_hex_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (pio_hex_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (pio_hex_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (pio_hex_s1_burst_adapter_source0_channel),       //                .channel
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_hex_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                              //       clk.clk
		.reset             (pio_keys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pio_hex_s1_agent_rdata_fifo_src_data),       //        in.data
		.in_valid          (pio_hex_s1_agent_rdata_fifo_src_valid),      //          .valid
		.in_ready          (pio_hex_s1_agent_rdata_fifo_src_ready),      //          .ready
		.out_data          (pio_hex_s1_agent_rdata_fifo_out_data),       //       out.data
		.out_valid         (pio_hex_s1_agent_rdata_fifo_out_valid),      //          .valid
		.out_ready         (pio_hex_s1_agent_rdata_fifo_out_ready),      //          .ready
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	eind_opdracht_design_mm_interconnect_0_router router (
	...
	eind_opdracht_design_mm_interconnect_0_router router_001 (
	...
	eind_opdracht_design_mm_interconnect_0_router_002 router_002 (
	...
	eind_opdracht_design_mm_interconnect_0_router_002 router_003 (
	...
	eind_opdracht_design_mm_interconnect_0_router_002 router_004 (
	...
	eind_opdracht_design_mm_interconnect_0_router_002 router_005 (
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (pio_keys_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (pio_switches_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (pio_switches_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (pio_switches_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (pio_switches_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (pio_switches_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (pio_switches_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (pio_hex_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (pio_hex_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (pio_hex_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (pio_hex_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (pio_hex_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (pio_hex_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	eind_opdracht_design_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	eind_opdracht_design_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	eind_opdracht_design_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (pio_keys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	eind_opdracht_design_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (pio_keys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	eind_opdracht_design_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (pio_keys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	eind_opdracht_design_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (pio_keys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	eind_opdracht_design_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (pio_keys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	eind_opdracht_design_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (pio_keys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	eind_opdracht_design_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (pio_keys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	eind_opdracht_design_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (pio_keys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	eind_opdracht_design_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	eind_opdracht_design_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	eind_opdracht_design_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
		...
		.in_rst_0_reset (pio_keys_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
	...
	eind_opdracht_design_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (pio_keys_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (pio_switches_s1_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (pio_switches_s1_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (pio_switches_s1_agent_rdata_fifo_out_ready), //         .ready
	...
	eind_opdracht_design_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (pio_keys_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (pio_hex_s1_agent_rdata_fifo_out_data),       //     in_0.data
		.in_0_valid     (pio_hex_s1_agent_rdata_fifo_out_valid),      //         .valid
		.in_0_ready     (pio_hex_s1_agent_rdata_fifo_out_ready),      //         .ready
